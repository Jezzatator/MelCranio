...
export class Convert {
    public static toHome(json: string): HomeModel {
        return cast(JSON.parse(json), r("Home"));
    }

    public static homeToJson(value: HomeModel): string {
...
const typeMap: any = {
    ...
    "Attributes": o([
        { json: "subNameFirstCard", js: "subNameFirstCard", typ: "" },
